    ...
    return (
        <header className="shadow-md relative">
            ...
            <div className='left-menu min-h-screen max-h-screen origin-[50%_200px_0] [&.active]:scale-[1.11111111] transition-transform duration-700 ease-in-out fixed top-0 left-0 bottom-0 right-0 overflow-y-auto z-30 text-white -translate-x-[100%] [&.active]:translate-x-0 opacity-0 [&.mactive]:opacity-100' style={{ background: `linear-gradient(rgb(0 0 0 / 52%), rgb(0 0 0 / 52%)), url("${config.menu_background}") no-repeat top / cover` }}>
                <div className='flex justify-end'><CloseIcon onClick={()=>{app.classList.remove('active'); left_menu.classList.remove('active'); right_menu.classList.remove('mactive'); left_menu.classList.add('mactive');}} className='p-5 box-content cursor-pointer' style={{fontSize:'32px'}} /></div>
            </div>
            <div className='right-menu min-h-screen max-h-screen origin-[50%_200px_0] [&.active]:scale-[1.11111111] transition-transform duration-700 ease-in-out fixed top-0 left-0 bottom-0 right-0 overflow-y-auto z-30 text-white translate-x-[100%] [&.active]:translate-x-0 opacity-0 [&.mactive]:opacity-100' style={{ background: `linear-gradient(rgb(0 0 0 / 52%), rgb(0 0 0 / 52%)), url("${config.menu_background}") no-repeat top / cover` }}>
                <div className='flex justify-end'><CloseIcon onClick={()=>{app.classList.remove('active'); right_menu.classList.remove('active'); right_menu.classList.add('mactive'); left_menu.classList.remove('mactive');}} className='p-5 box-content cursor-pointer' style={{fontSize:'32px'}} /></div>
            </div>
        </header>
    )
}
