  ...
  return (
    <div className="group w-full md:w-1/2 px-5 md:px-[10px] lg:px-5 py-4" title={title}>
      <Link to={`/${url}`} className="relative w-full block overflow-hidden pb-[50%]">
        <LazyLoad><img className="absolute top-0 left-0 right-0 bottom-0 w-full h-full object-cover transition-all duration-[.5s]" src={img_url ? img_url : `/img/articles/485x360/${img_comp}.jpg`} alt={title} /></LazyLoad>
