                ...
                <div className='md:max-w-screen-md lg:max-w-screen-lg lg1140:max-w-[1068px] px-5 lg:px-[22px] lg1140:px-0 m-auto pt-8 md:pt-11'>
                    <div className='flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-[28px] lg:space-x-11'>
                        <div className='w-full md:w-2/3'>
                            <div className='flex flex-wrap flex-col md:flex-row -mx-5 md:-mx-[10px] lg:-mx-5 -my-4'>
                                <div className="w-full md:w-1/2 px-5 md:px-[10px] lg:px-5 py-4">
                    ...
                    <div className='flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-[28px] lg:space-x-11'>
                        <div className='w-full md:w-2/3'>
                            <div className='flex flex-col md:flex-row -mx-5 md:-mx-[10px] lg:-mx-5 -my-4'>
                                <div className='w-full md:w-[38%] px-5 md:px-[10px] lg:px-5 py-4'>
                                    <Link to='/'><LazyLoad><img src="/img/newspaper-11-logo-white.png" alt="" /></LazyLoad></Link>
                                </div>
                                <div className='w-full md:w-[62%] px-5 md:px-[10px] lg:px-5 py-4'>
                                    <h4 className='text-[19px] mb-7 font-semibold uppercase'>About Us</h4>
                                    <p className='text-[14.5px] mb-5'>Newspaper is your news, entertainment, music fashion website. We provide you with the latest breaking news and videos straight from the entertainment industry.</p>
                        ...
                        <div className='w-full md:w-1/3'>
                            <h4 className='text-[19px] mb-7 font-semibold uppercase'>Follow Us</h4>
                            <div>
