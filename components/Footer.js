...
const Footer = () => {
    ...
    return (
        <footer className='mt-7 md:mt-11'>
            <div className='w-full text-white' style={{ background: `linear-gradient(rgb(0 0 0 / 80%), rgb(0 0 0 / 80%)), url("${config.footer_background}") no-repeat top / cover` }}>
                <div className='md:max-w-screen-md lg:max-w-screen-lg lg1140:max-w-[1068px] px-5 lg:px-[22px] lg1140:px-0 m-auto py-8 md:py-11'>
                                ...
                                <div>
                                    <ul>
                                        {category.concat().splice(0, 6).map((e, i) => (<li key={i} className='flex justify-between space-y-2.5 group'>
                                            <Links className='text-sm md:text-[12.5px] lg:text-sm md:leading-5 text-white group-hover:text-sky-400 font-medi groupum' to="/">{e.name}</Links>
                                            <Links className='text-sm md:text-[12.5px] lg:text-sm md:leading-5 text-white group-hover:text-sky-400 font-medium' to="/">20</Links>
                                        </li>))}
                                    </ul>
                                </div>
                            </div>
                ...
                <div className='md:max-w-screen-md lg:max-w-screen-lg lg1140:max-w-[1068px] px-5 py-4 md:py-2.5  lg:px-[22px] lg1140:px-0 m-auto text-12px flex flex-col md:flex-row space-y-4 md:space-y-0 justify-between'>
                   ...
                   <div className='m-auto md:m-0 md:ml-auto'>
                        <ul className='flex -m-2'>
                            <li className='p-2'><Links to='/'>Disclaimer</Links></li>
                            <li className='p-2'><Links to='/'>Privacy</Links></li>
                            <li className='p-2'><Links to='/'>Advertisement</Links></li>
                            <li className='p-2'><Links to='/'>Contact us</Links></li>
                        </ul>
                   </div>
                </div>
            </div>
